...
///////////////////////////////////////////////////////////////////////////
	...
	$address = "html5awesome@gmail.com";
...
// Please Note, we cannot support this file package if modifications have been made below this line.
	...
	$error = '';
		...
		if(!isValidURL($url) && trim($url) !='') {
			$error .= '<li>Please enter valid URL including http://.</li>';
		}
		...
		if($twitter_active == 1) {
			...
			$twitter_msg = $name . " - " . $comments . ". You can contact " . $name . " via email, " . $email;
